...
export declare function clickElement(
  pid: number,
  query: AxQuery,
): Promise<void>;

export declare function doubleClickElement(
  pid: number,
  query: AxQuery,
): Promise<void>;
...
export declare function rightClickElement(
  pid: number,
  query: AxQuery,
): Promise<void>;
...
export declare function waitForElement(
  pid: number,
  query: AxQuery,
  opts?: WaitOptions | undefined | null,
): Promise<AxElementInfo>;

export declare function waitForGone(
  pid: number,
  query: AxQuery,
  opts?: WaitOptions | undefined | null,
): Promise<void>;
